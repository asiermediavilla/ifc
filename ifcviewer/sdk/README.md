...
The iframe has no language selector. The host owns language choice. Supported codes are `en`, `es`, `eu` and `fr`; IFC-derived names/classes/properties are not translated.
